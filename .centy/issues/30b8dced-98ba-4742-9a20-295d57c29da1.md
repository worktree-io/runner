...
updatedAt: 2026-02-21T22:25:05.030022+00:00
---
...
4. Optionally, store `id` as `uuid::Uuid` in `IssueRef::Linear` instead of a raw `String` — this makes invalid UUIDs unrepresentable at the type level.
